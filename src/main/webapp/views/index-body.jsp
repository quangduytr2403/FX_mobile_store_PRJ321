			...
			<ul class="pagination">
				...
				<c:choose>
					<c:when test="${currentPage != 1}">
						<li class="page-item"><a class="page-link" href="../home/${currentPage - 1}">Previous</a></li>
					</c:when>
					<c:otherwise>
				...
				<c:forEach var="counter" begin="1" end="${totalPages}">
					<c:choose>
						<c:when test="${currentPage != counter}">
							<li class="page-item"><a class="page-link" href="../home/${counter}">${counter}</a></li>
						</c:when>
						<c:otherwise>
				...
				<c:choose>
					<c:when test="${currentPage != totalPages}">
						<li class="page-item"><a class="page-link" href="../home/${currentPage + 1}">Next</a></li>
					</c:when>
					<c:otherwise>
						<li class="page-item"><a class="page-link">Next</a></li>
					</c:otherwise>
				</c:choose>
				<li class="page-item"><a class="page-link" href="../home/${totalPages}">Last</a></li> 
			</ul>
		</div>
	</div>
